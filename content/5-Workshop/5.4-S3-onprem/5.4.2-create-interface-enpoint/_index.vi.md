...
+ Äáº·t tÃªn interface endpoint
+ Trong Service category, chá»n **aws services** 

![name](/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint1.png)

3.  Trong Search box, gÃµ S3 vÃ  nháº¥n Enter. Chá»n endpoint cÃ³ tÃªn com.amazonaws.us-east-1.s3. Äáº£m báº£o ráº±ng cá»™t Type cÃ³ giÃ¡ trá»‹ Interface.
